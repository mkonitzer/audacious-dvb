...
#ifdef DVB_ATSC
    case FE_ATSC:
      log_print (hlog, LOG_INFO, "tuning ATSC to %d, modulation=%d\n", t->freq,
	       t->mod);
      feparams.frequency = t->freq;
